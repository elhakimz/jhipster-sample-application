...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.PartyRole}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class PartyRoleResource {
    ...
    public ResponseEntity<PartyRole> createPartyRole(@Valid @RequestBody PartyRole partyRole) throws URISyntaxException {
    ...
    public ResponseEntity<PartyRole> updatePartyRole(@Valid @RequestBody PartyRole partyRole) throws URISyntaxException {
